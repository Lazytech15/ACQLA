    ...
    client.collection("COMLAB-ATTENDANCE-TABLE").onSnapshot((querySnapshot) => {
      ...
      deskStat.forEach((data)=>{
        if (data.Status==="Occupied" && data.SchoolOnTime==="true"){
          ...
          stud_late.innerHTML = Number(stud_ontime.innerHTML) + 2;
          ...
          if(cells[i].innerHTML !== ""){
            deskStat.forEach((onValue)=>{
              ...
              if(i === desk){ 
                ...
                //document.getElementById('minimal-details-info').style="display: none;";
            ...
            //document.getElementById('minimal-details-info').style="display: flex;";
